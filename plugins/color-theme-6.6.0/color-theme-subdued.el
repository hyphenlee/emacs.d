...
Based on the Tango color palette."
  ...
  (color-theme-install
   '(color-theme-subdued
     ((foreground-color . "#9CAC8C")    ;custom by winterTTr, greener
     ...
     (default ((t (nil))))
     (font-lock-comment-face ((t (:foreground "#6A6F63")))) ; dark aluminum, custom by winterTTr , lighter
     ...
     (font-lock-string-face ((t (:foreground "#996E9E")))) ; plum, custom by winterTTr, lighter
     ...
     ;; Search
     (isearch ((t (:foreground "#080808" :background "#C9B400")))) ;custom by winterTTr, not so yellow
     (isearch-lazy-highlight-face ((t (:foreground "#080808" :background "#607981")))) ;custom by winterTTr, background lighter
